...
# Define o título da página, o ícone e o layout para ocupar a largura total.
st.set_page_config(
...
st.markdown("Análise dos salários na área de dados com base em diversos filtros.")
